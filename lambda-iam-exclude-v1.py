...
def lambda_handler(event, context):
    try:
        ...
        # Attempt to extract username from both direct and session context
        user_name = user_identity.get('userName') or user_identity.get('sessionContext', {}).get('sessionIssuer', {}).get('userName', 'N/A').lower()
